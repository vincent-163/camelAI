/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/telegram-lite/wrangler.jsonc workers/telegram-lite/worker-configuration.d.ts` (hash: d20b0ba172718a61895cdbdc0ae3a583)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_CHAT_ID" | "GITHUB_OWNER" | "GITHUB_REPO" | "GITHUB_BRANCH" | "AI_MODEL">> {}
}
