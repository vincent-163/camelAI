/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/telegram-lite/wrangler.jsonc workers/telegram-lite/worker-configuration.d.ts` (hash: bee3534a63259082c91ff1110618597d)
