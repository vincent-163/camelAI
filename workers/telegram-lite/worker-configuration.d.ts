/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/telegram-lite/wrangler.jsonc workers/telegram-lite/worker-configuration.d.ts` (hash: 510c48bbb66d6ba48cf4da711a6f24f2)
// Runtime types generated with workerd@1.20260722.1 2026-07-29 nodejs_compat
interface __BaseEnv_Env {
	ALLOWED_CHAT_ID: "524019827";
	GITHUB_OWNER: "vincent-163";
	GITHUB_REPO: "camelAI";
	GITHUB_BRANCH: "main";
	AI_BASE_URL: "https://workers.v-163.top/ai/v1";
	AI_MODEL: "gpt-5.6-sol";
	TELEGRAM_SESSIONS: DurableObjectNamespace<import("./src/index").TelegramSession>;
	TELEGRAM_ROUTER: DurableObjectNamespace<import("./src/index").TelegramRouter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TelegramSession" | "TelegramRouter";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_CHAT_ID" | "GITHUB_OWNER" | "GITHUB_REPO" | "GITHUB_BRANCH" | "AI_BASE_URL" | "AI_MODEL">> {}
}
